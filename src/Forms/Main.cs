    ...
    public sealed partial class Main : Form
    {
        ...
        public Main()
        {
            try
            {
                ...
                mediaPlayer.SubtitleTextUpper = string.Empty;
                mediaPlayer.SubtitleTextUpperTop = string.Empty;
                mediaPlayer.SubtitleTextUpperTopLeft = string.Empty;
                mediaPlayer.SubtitleTextUpperTopRight = string.Empty;
                mediaPlayer.SubtitleTextUpperCenter = string.Empty;
                mediaPlayer.SubtitleTextBottomLeft = string.Empty;
                mediaPlayer.SubtitleTextBottomRight = string.Empty;
        ...
        private void ShowSettings()
        {
                ...
                oldSyntaxColoring != newSyntaxColoring)
            {
                ...
                mediaPlayer.SetSubtitleFontUpper();
                mediaPlayer.SetSubtitleFontUpperTop();
                mediaPlayer.SetSubtitleFontUpperTopLeft();
                mediaPlayer.SetSubtitleFontUpperTopRight();
        ...
        */
        ...
        public void ReDockVideoPlayer(Control control)
        {
            ...
            mediaPlayer.SetSubtitleFontUpperTopLeft();
            mediaPlayer.SetSubtitleFontUpperTopRight();
            mediaPlayer.SetSubtitleFontUpperCenter();
            mediaPlayer.SetSubtitleFontBottomLeft();
            mediaPlayer.SetSubtitleFontBottomRight();
