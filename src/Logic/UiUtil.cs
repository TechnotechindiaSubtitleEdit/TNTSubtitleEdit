    ...
    internal static class UiUtil
    {
        ...
        public static int GetSubtitleIndex(List<Paragraph> paragraphs, VideoPlayerContainer videoPlayerContainer)
        {
            if (videoPlayerContainer.VideoPlayer != null)
            {
                ...
                if (!string.IsNullOrEmpty(videoPlayerContainer.SubtitleTextUpper))
                    videoPlayerContainer.SetSubtitleTextUpper(string.Empty, null);
                if (!string.IsNullOrEmpty(videoPlayerContainer.SubtitleTextUpperTop))
                    videoPlayerContainer.SetSubtitleTextUpperTop(string.Empty, null);
                if (!string.IsNullOrEmpty(videoPlayerContainer.SubtitleTextUpperTopLeft))
                    videoPlayerContainer.SetSubtitleTextUpperTopLeft(string.Empty, null);
                if (!string.IsNullOrEmpty(videoPlayerContainer.SubtitleTextUpperTopRight))
                    videoPlayerContainer.SetSubtitleTextUpperTopRight(string.Empty, null);
                if (!string.IsNullOrEmpty(videoPlayerContainer.SubtitleTextUpperCenter))
                    videoPlayerContainer.SetSubtitleTextUpperCenter(string.Empty, null);
                if (!string.IsNullOrEmpty(videoPlayerContainer.SubtitleTextBottomLeft))
                    videoPlayerContainer.SetSubtitleTextBottomLeft(string.Empty, null);
                if (!string.IsNullOrEmpty(videoPlayerContainer.SubtitleTextBottomRight))
                    videoPlayerContainer.SetSubtitleTextBottomRight(string.Empty, null);
            }
            return -1;
        }
                        ...
                        p.EndTime.TotalMilliseconds > positionInMilliseconds)
                    {
                        ...
                        if (!isInfo)
                        {
                            if (videoPlayerContainer.LastParagraph != p)
                            {
                                ...
                                videoPlayerContainer.SetSubtitleTextUpper(text, p);
                                videoPlayerContainer.SetSubtitleTextUpperTop(text, p);
                                videoPlayerContainer.SetSubtitleTextUpperTopLeft(text, p);
                                videoPlayerContainer.SetSubtitleTextUpperTopRight(text, p);
                                videoPlayerContainer.SetSubtitleTextUpperCenter(text, p);
                                videoPlayerContainer.SetSubtitleTextBottomLeft(text, p);
                                videoPlayerContainer.SetSubtitleTextBottomRight(text, p);
                            }
                            else if (videoPlayerContainer.SubtitleTextUpper != text)
                            {
                                //videoPlayerContainer.SetSubtitleText(text, p);
                                videoPlayerContainer.SetSubtitleTextUpper(text, p);
                                videoPlayerContainer.SetSubtitleTextUpperTop(text, p);
